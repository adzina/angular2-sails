...
export class NavbarComponent{
  ...
  navigate(nr: number){
    switch(nr){
      ...
      case(4): this._router.navigate(['./teacher-create-lesson']);break;
      case(5): this._router.navigate(['./teacher-words-panel']);break;
      case(6): this._router.navigate(['./teacher-add-students']);break;
      case(7): this._router.navigate(['./teacher-see-progress']);break;
      case(8): this._router.navigate(['./goodbye']);break;
    }
  }
}
